        ...
        <header>
          <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
            <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
              ...
              <span class="fs-4">Plans For Rent</span>
            </a>

          </div>
      
          <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
            <h1 class="display-4 fw-normal">Pricing Of Different Plans</h1>
            <p class="fs-5 text-muted">We Created This Plans According To Customers Convenience.There Are 3 Different Type Of Plans And Each Of Them Are Monthly Plans.</p>
          </div>
        </header>
        ...
        <main>
          <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
            <div class="col">
              <div class="card mb-4 rounded-3 shadow-sm">
                <div class="card-header py-3">
                  <h4 class="my-0 fw-normal">Basic(Free For One Month)</h4>
                </div>
                <div class="card-body">
            ...
            <div class="col">
              <div class="card mb-4 rounded-3 shadow-sm">
                <div class="card-header py-3">
                  <h4 class="my-0 fw-normal">Standard(Free For One Month)</h4>
                </div>
                <div class="card-body">
